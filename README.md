...
)然后安装：python get-pip.py）,然后添加脚本(如C:\Python27\Scripts)到系统路径里。详情见:[Installing Packages](https://packaging.python.org/tutorials/installing-packages/). 以后可以用pip安装package了，如 ：pip install pandas
